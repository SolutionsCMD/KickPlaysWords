...
const DEFAULT_WORD_LISTS = {
  4: ['word','game','chat','kick','live','fire','star','moon','king','fish','bird','tree','snow','rain','wind','rock','wave','duck','bear','wolf','frog','lion','deer','lamp','door','book','bell','ship','coin','leaf','flag','gift','hook','horn','iron','keys','kite','knot','lock','maze','nail','nest','pipe','pool','safe','soap','tank','tool','trap','tube','vase','wand','wire','bold','calm','cold','dark','deep','fair','glad','hope','kind','love','mild','pure','rare','warm','weak','wild','wise','band','bass','beat','blue','draw','film','gold','hero','jazz','mask','myth','note','play','poem','role','show','sing','solo','song','soul','tale','text','tune','vibe'],
  5: ['guess','sport','music','dance','power','earth','ocean','snake','tiger','mouse','horse','shark','eagle','plant','stone','clock','magic','sword','crown','quest','storm','flame','frost','ghost','angel','beast','spell','charm','brain','dream','night','light','heart','beach','blaze','brave','chain','chase','clash','climb','cloud','crash','cross','crush','drift','feast','flash','float','forge','frame','grace','grand','guard','honor','jewel','judge','knock','lunar','march','mercy','noble','orbit','peace','pearl','pride','prize','pulse','queen','rapid','realm','reign','rival','royal','saint','scale','scout','shade','sharp','shelf','shift','shine','skill','skull','slide','solar','spark','spear','spine','staff','stain','stand','steal','steam','steel','stern','stick','sting','sweep','swift','thief','thorn','torch','tower','trace','trail','trend','trick','trust','truth','twist','unity','valor','vault','vigor','vital','watch','weave','wheel','witch','world','wound','wrath','yield'],
  6: ['stream','coffee','artist','dragon','castle','forest','island','planet','rocket','spider','wizard','knight','pirate','jungle','desert','winter','summer','spring','legend','empire','palace','temple','energy','spirit','shadow','anchor','banner','beacon','bounty','breeze','bridge','bronze','candle','canyon','cobalt','combat','copper','crisis','dagger','divine','escape','falcon','frozen','galaxy','gentle','goblet','golden','gravel','hammer','harbor','hollow','hunter','hustle','impact','jigsaw','kindle','ladder','magnet','marble','meadow','mirror','mosaic','needle','orphan','outlaw','pardon','plague','pledge','plunge','poison','portal','powder','prison','puzzle','quartz','random','ransom','reason','ribbon','riddle','ripple','rustic','saddle','safari','scroll','secret','signal','silver','sketch','socket','sorrow','stolen','summit','sunset','tender','throne','ticket','timber','toggle','trophy','tumble','unlock','vandal','velvet','vessel','vision','vortex','voyage','wander','weapon','wealth','wicked','wonder','wraith','zenith'],
  7: ['chicken','monster','penguin','rainbow','dolphin','element','diamond','volcano','thunder','phoenix','kingdom','emperor','mystery','fantasy','destiny','harmony','freedom','justice','warrior','ancient','eternal','crystal','phantom','journey','triumph','miracle','balance','banquet','barrier','bastion','battery','beloved','benefit','blanket','blossom','boulder','brother','cabinet','captain','capture','cascade','catalog','caution','certain','chamber','channel','chapter','chariot','circuit','citadel','climate','cluster','coastal','combine','comfort','command','compact','compass','complex','concept','concert','conduct','confine','conquer','control','convert','cottage','council','country','courage','creator','crimson','crusade','culture','current','curtain','customs','cyclone','default','defense','deliver','destroy','develop','digital','display','dispute','distant','dungeon','eclipse','economy','elegant','embrace','emerald','emotion','enchant','endless','episode','essence','examine','example','excited','exhibit','expense','explain','explore','express','extinct','extreme','factory','fashion','feature','fiction','fixture','flutter','foreign','formula','fortune','fragile','freight','gateway','general','genuine','glacier','glimpse','gravity','habitat','hamster','harvest','heading','healthy','heroism','highway','history','horizon','housing','hundred','imagine','inquiry','instant','involve','journal','kitchen','lantern','leather','leopard','liberty','limited','lottery','machine','manager','mansion','mastery','medical','mercury','militia','mineral','mission','mixture','monitor','morning','natural','network','notable','nuclear','obscure','opinion','optimal','organic','origins','outlook','overall','pacific','package','panther','passage','patriot','pattern','payment','penalty','pension','perfect','picture','pilgrim','pioneer','plastic','plumber','pottery','premium','present','private','problem','proceed','produce','profile','program','project','promise','promote','prophet','protect','protest','provide','publish','pyramid','quarter','radical','reactor','reality','rebuild','receive','recover','recruit','reflect','regular','removal','renewal','replace','request','reserve','resolve','restore','retreat','reunion','reverse','routine','royalty','salvage','scholar','section','shelter','silence','slender','society','soldier','sparrow','special','sponsor','station','stealth','stellar','storage','strange','stretch','subject','success','sunrise','support','supreme','surface','surplus','survive','suspect','sustain','tactics','tempest','terrain','thought','tornado','tourism','tracker','trading','tragedy','trainer','transit','tribune','tribute','trigger','trouble','trumpet','tsunami','turbine','typical','uncover','uniform','unknown','uranium','vaccine','vanilla','variety','venture','verdict','version','veteran','victory','village','vintage','virtual','vulture','walkway','warrant','weather','western','whistle','wildcat','witness','worship','written']
};
...
function createRoom() {
  ...
  const room = {
    ...
    shuffleWordLength: false, expandedWordPool: false, tenXWordPool: true, hideLetterCount: false, prizeAmount: '',
